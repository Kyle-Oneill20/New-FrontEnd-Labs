...
describe('question 1a, the array of numbers',()=>{
...
describe('question 1b, My Wallet', () =>{
  class Wallet {
  ...
  it('#should be able to remove moeny from wallet', () =>{
    let myWallet = new Wallet(10)
...
describe('#Question 1c, Day of the Week', ()=>{
    ...
    it('#should return Tuesday with input 2', ()=>{
  ...
  describe('#question 1d, Movie characters',()=>{
    ...
    it('#should return array of object.isAWizard should be true', ()=>{
